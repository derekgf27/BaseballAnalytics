        ...
        <div className="flex items-center justify-between border-b border-[var(--border)] px-4 py-3">
          <div>
            ...
            <p className="mt-1 text-xs text-[var(--text-muted)]">
              {isOur
                ? "Click or drag players into batting order. Available players are the main roster (pitchers excluded — set them on the game). Use “—” in Pos to clear a spot while swapping positions."
