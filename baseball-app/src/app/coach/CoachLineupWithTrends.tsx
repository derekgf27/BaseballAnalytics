...
import type { TodayGameInfo, TodayLineupSlot } from "./CoachTodayClient";

interface CoachLineupWithTrendsProps {
  game: TodayGameInfo | null;
  recommendedLineup: TodayLineupSlot[];
}

/**
 * Lineup table + hot/cold trends (Last 20 PA). Shared by dashboard and Today.
 */
export function CoachLineupWithTrends({ game, recommendedLineup }: CoachLineupWithTrendsProps) {
  return (
    <section>
            ...
            {hot.length > 0 && (
              <div>
                <p className="mb-2 flex items-center gap-1.5 text-sm font-medium">
                  ...
                  <span className="text-[var(--decision-hot)]">Hot</span>
                </p>
