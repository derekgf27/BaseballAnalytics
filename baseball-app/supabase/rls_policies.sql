...
create policy "ba_authenticated_all" on public.pitch_events for all to authenticated using (true) with check (true);
...
create policy "ba_authenticated_all" on public.pitches for all to authenticated using (true) with check (true);
