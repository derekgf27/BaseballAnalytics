...
create table if not exists public.games (
  ...
  save_pitcher_id uuid references public.players(id) on delete set null,
  winning_pitcher_id uuid references public.players(id) on delete set null,
  losing_pitcher_id uuid references public.players(id) on delete set null,
